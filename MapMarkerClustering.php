...
class MapMarkerClustering extends Widget
{
    ...
    public function run()
    {
        echo Html::beginTag('div', ['id' => (empty($this->options['id']) ? $this->getId() : $this->options['id']), 'class' => $this->options['class']]);
    ...
    public function registerClientScript()
    {
       ...
       function initMap() {
        ...
        var markerCluster = new MarkerClusterer(map, markers,
            {imagePath: 'http://chart.apis.google.com/chart?cht=mm&chs=24x32&' +
          'chco=FFFFFF,008CFF,000000&ext=.png'});
      }
